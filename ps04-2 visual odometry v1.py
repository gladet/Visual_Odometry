...
vertical_thresh = 6 #8 #4 #6 #2 #4 #8 #6 #3 #2 #4 # max number of pixels up or down allowed in epipolar matching (ideal epipolar has zero pixels up/down)
score_thresh = 64 #80 #32 #64 #96 #32 #80 #48 #64 # maximum hamming distance between points to be considered a match
...
frame_start = 0 #4 #0 #100 #4 #80 #100 #4 #80 #0 #80 #100 #4 #80 #100 #4 #0
frame_end = 999 #6 #999 #102 #6 #120 #102 #6 #120 #999 #120 #102 #6 #120 #102 #6 #10
...
def determine_motion(image_x, image_y, pts_3D, cam):
    ...
    def apply_motion(motion):
        ...
        RT = np.array([[ c, 0, s, tx],
                       [ 0, 1, 0,  0],
                       [-s, 0, c, tz],
                       [ 0, 0, 0,  1]]) #[R/T] -> transformation matrix
